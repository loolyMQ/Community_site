...
const CommunityGraph: React.FC = () => {
  ...
  return (
    <div className="graph-view">
      ...
      {/* Мини модальное окно с инструкцией */}
      {showInfoModal && (
        <div className="modal-overlay" onClick={() => setShowInfoModal(false)}>
          <div className="modal modal-instruction" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <h2>Как использовать граф</h2>
              <button className="modal-close" onClick={() => setShowInfoModal(false)}>×</button>
            </div>
            <div className="modal-body">
              <p><strong>🖱️ Мышь:</strong></p>
              <ul>
                <li>Перетаскивание: зажмите левую кнопку и двигайте</li>
                <li>Зум: прокрутите колесико мыши</li>
                <li>Выбор сообщества: кликните на узел</li>
              </ul>
              
              <p><strong>📱 Сенсорный экран:</strong></p>
              <ul>
                <li>Перетаскивание: проведите пальцем по экрану</li>
                <li>Зум: сведите/разведите два пальца</li>
                <li>Выбор сообщества: коснитесь узла</li>
              </ul>
              
              <p><strong>🎯 Узлы:</strong></p>
              <ul>
                <li>Цветные круги = сообщества</li>
                <li>Линии = связи между сообществами</li>
                <li>Размер = количество участников</li>
              </ul>
              
              <p><strong>💬 По всем вопросам обращайтесь в <a href="https://t.me/a_attuu" target="_blank" rel="noopener noreferrer">Telegram</a></strong></p>
            </div>
          </div>
        </div>
      )}
